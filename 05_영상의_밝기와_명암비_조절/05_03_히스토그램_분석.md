...
* 히스토그램 평활화 수식
> * <img src="./img/OCV008.PNG" width="400"/> <br/> g : 그레이스케일 값, h(g) : 그레이스케일 값이 g인 픽셀 개수를 구하는 함수, H(g) : 히스토그램 누적 함수
> * <img src="./img/OCV009.PNG" width="400"/> <br/> Lmax : 영상이 가질 수 있는 최대 밝기 값, N : 입력 영상의 전체 픽셀 개수, round() : 반올림 함수
